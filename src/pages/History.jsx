      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          <div>
            ...
            <p className="text-slate-500 dark:text-zinc-400 mt-2 flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row w-full md:w-auto gap-4">
            ...
            <div className="relative flex-1 md:w-64">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 focus:ring-2 focus:ring-indigo-500 outline-none text-sm transition-all"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredHistory.map((item) => {
              ...
              return (
                <div 
                  key={item.id} 
                  className="group relative bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-zinc-800 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
                >
                  {/* Visual Header */}
                  <div className={`h-36 relative flex items-center justify-center overflow-hidden bg-gradient-to-br ${config.gradient}`}>
