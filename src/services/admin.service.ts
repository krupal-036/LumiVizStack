...
export const getSettings = async () => {
    try {
        ...
        return responseHandler(500, { message: "Failed to load system settings." });
    }
}
...
export const updateSettings = async (data: any) => {
    try {
        ...
        return responseHandler(500, { message: "Failed to update system settings." });
    }
};
...
export const getStats = async () => {
    try {
        ...
        return responseHandler(200, { users: userCount, records: historyCount, isPublic: publicCount, isDeleted: deletedCount });
    } catch (err) {
        return responseHandler(500, { message: "Failed to load dashboard statistics." });
    }
}
...
export const getUsersStats = async () => {
    try {
        ...
        return responseHandler(500, { message: "Failed to get users with history counts." });
    }
};
...
export const toggleUserStatus = async (userId: any) => {
    try {
        ...
        return responseHandler(500, { message: "Failed to toggle user status." });
    }
}
...
export const removeUserAndHistory = async (userId: any) => {
    try {
        ...
        const delHistory = await historyRepo.deleteManyByField({ userId: userId });
        return responseHandler(200, { message: `${user.username} and its associated ${delHistory.deletedCount} history document deleted successfully` });
    } catch (err) {
        return responseHandler(500, { message: "Error occured during Deletion of User & its all History" });
    }
}
...
export const removeHistoryCollection = async () => {
    try {
        ...
        return responseHandler(200, { message: `Total ${result.deletedCount} history records have been permanently deleted` });
    } catch (err) {
...
export const removeAllHistoryOfUserById = async (userId: any) => {
    try {
        ...
        return responseHandler(500, { message: "Error Occured during Deletion of User's History" });
    }
}
