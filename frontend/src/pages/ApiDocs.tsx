...
const MethodBadge = ({ method }: MethodBadgeProps) => {
    const colors: Record<MethodBadgeProps["method"], string> = {
        ...
        DELETE: "bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-400 border-red-200 dark:border-red-700",
        PATCH: "bg-purple-100 text-purple-700 dark:bg-purple-900/40 dark:text-purple-400 border-purple-200 dark:border-purple-700",
    };

    return (
        <span className={`px-2.5 py-1 text-xs font-bold rounded-md border ${colors[method]}`}>
            {method}
        </span>
    );
};
        ...
        <div className="group relative flex flex-col md:flex-row md:items-center gap-4 p-4 mb-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm shadow-sm hover:shadow-md hover:border-indigo-500/40 transition-all duration-200">
            ...
            <div className="flex items-center gap-3 min-w-0 md:min-w-[320px]">
                ...
                <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-xs text-gray-400 md:hidden">{method} endpoint</span>
                </div>
            </div>
    ...
    const apiData: Record<string, EndpointRowProps[]> = {
        auth: [
            ...
            },
            {
                method: "POST",
                path: "/auth/login",
                description: "Authenticates credentials and returns a secure session token.",
            },
        ],
        history: [
            {
                ...
                path: "/history/save",
                description:
                    "Saves a new visualization configuration to the database. (Max 10 per each user)",
            },
            {
                method: "PUT",
                path: "/history/:id/toggle",
            ...
            },
            {
                ...
                path: "/history/user",
                description:
                    "Retrieves all saved visualization sessions for the authenticated user.",
            },
            {
                method: "DELETE",
                path: "/history/:id",
            ...
            {
                method: "DELETE",
                path: "/history/delete-all",
                description: "Delete all history items.",
            },
            {
                method: "PUT",
                path: "/history/delete-all",
                description: "Mark all history as deleted (Soft Delete)",
            },
            {
                method: "GET",
                path: "/history/public/:shareId",
                description:
                    "Get Access to saved public history by Share ID (accessible by anyone)",
            },
        ],
        admin: [
            { method: "GET", path: "/admin/settings", description: "Get System Setting data" },
            {
                ...
                description: "Modify System Setting Data admin only",
            },
            {
                method: "GET",
                path: "/admin/stats",
                description: "Get all document counts (User and History)",
            },
            {
                method: "GET",
                path: "/admin/users",
                description: "Get All Users with selected fields",
            },
            {
                method: "GET",
                path: "/admin/history",
                description: "Get All istory collection data at Admin panel",
            },
            {
                method: "PUT",
                path: "/admin/user/:id",
                description: "Desable User / Soft Delete User",
            },
            {
                method: "DELETE",
                path: "/admin/user/:id",
                description: "Delete User and all associated history of User",
            },
            {
                method: "DELETE",
                path: "/admin/history",
                description:
                    "Delete all visualization history of History Collection at Admin Panel",
            },
            {
                method: "DELETE",
                path: "/admin/users/history/:id",
                description: "Delete all history of specific User at Admin Panel",
            },
        ],
        user: [
            { method: "PUT", path: "/profile/update", description: "Update Username and Password" },
            {
                method: "PUT",
                path: "/profile/delete",
                description: "Delete all visualization data and disable User",
            },
        ],
    };
    useTitle("API Docs");
            ...
            <div className="max-w-7xl mx-auto px-4 pt-10 sm:px-6 lg:px-8 pb-10">
                <div className="flex flex-col items-center justify-center mb-10 sm:mb-12 lg:mb-16 text-center px-4">
                    ...
                    <h1 className="flex flex-wrap items-center justify-center text-center text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-5 sm:mb-6">
                        ...
                        <span className="text-gray-900 dark:text-white">API Docs</span>
                    </h1>

                    <p className="max-w-xl sm:max-w-2xl mx-auto text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                        This document provides detailed information about the REST API endpoints
                        available in LumiVizStack. The API allows you to manage authentication,
                        history, and data visualization configurations programmatically.
                    </p>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-10 text-sm text-blue-700 dark:text-blue-300 flex gap-3 items-start">
                    ...
                    <div>
                        <strong>Information Only:</strong> This page is for reference purposes. To
                        interact with the API, use tools like Postman, cURL, or integrate with your
                        frontend application using the Base URL:{" "}
