            ...
            <div className="max-w-7xl mx-auto px-4 pt-10 sm:px-6 lg:px-8 sm:pt-4 xs:pt-4 pb-10">
                <div className="text-center max-w-3xl mx-auto mb-10 pt-4">
                    ...
                    <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                        A full-stack application designed to bridge the gap between raw data and
                        meaningful insights through interactive, real-time visualization.
                    </p>
                </div>
                <div className="mb-10">
                        ...
                        <div className="grid lg:grid-cols-12">
                            <div className="lg:col-span-8 p-8 sm:p-12">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed text-lg">
                                    Effortlessly convert raw JSON into actionable insights.
                                    LumiVizStack handles the heavy lifting—from graceful error
                                    handling to intelligent data parsing—letting you switch between
                                    dynamic charts, tables, and trees in a single click.
                                </p>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                Reusable React components with modern state
                                                management and Light/Dark mode support.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">
                                                Node.js & Express backend ensuring secure APIs,
