            ...
            <div className="max-w-7xl mx-auto px-4 pt-10 sm:px-6 lg:px-8 pb-20">
                ...
                <div className="mt-12 p-6 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-2xl">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <h3 className="font-bold text-indigo-900 dark:text-indigo-200">Pro Tip</h3>
                    </div>
                    <p className="text-sm text-indigo-700 dark:text-indigo-300">
                        If your JSON is an array of objects, the <strong>Table View</strong> works
                        best. For deeply nested trees, try the <strong>Tree View</strong> to explore
                        the hierarchy.
                    </p>
                </div>
