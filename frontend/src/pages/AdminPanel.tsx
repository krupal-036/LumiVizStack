...
import { FiUsers, FiDatabase, FiTrash2, FiActivity, FiUser, FiAlertTriangle, FiSettings, FiExternalLink } from "react-icons/fi";
...
const AdminPanel = () => {
  const [stats, setStats] = useState<AdminStats>({ users: 0, records: 0, isPublic: 0, isDeleted: 0 });
