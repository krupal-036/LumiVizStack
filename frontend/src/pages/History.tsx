...
export default function History() {
    ...
    const handleToggleStatus = async (id: string) => {
        ...
        try {
            ...
            if (res.ok) {
                setHistory((prev) => prev.map((item) => (item._id === id ? updatedItem : item)));
                                ...
                                <div className="grid grid-cols-2 md:flex md:flex-row items-center gap-3 w-full sm:w-auto">
                                    <div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 rounded-xl px-3 py-2 flex items-center gap-2 shadow-sm justify-center">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <span
                                                className={`text-sm font-bold ${savedCount >= limit ? "text-red-500" : "text-indigo-600 dark:text-indigo-400"}`}
                                            >
                                                {savedCount}
                                            </span>
                ...
                <div className="mb-6 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900/50 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-indigo-700 dark:text-indigo-300">
                            <strong>Public Links:</strong> Toggle your chart to "Public" to enable
                            sharing and open links.
                        </p>
                    </div>
                ...
                {loading ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[...Array(4)].map((_, i) => (
                            <div
                                key={i}
                                className="bg-white dark:bg-[#111827] rounded-2xl p-6 border border-gray-100 dark:border-gray-800 animate-pulse"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {history.map((item) => (
                            ...
                            >
                                <div
                                    className={`p-5 border-b border-gray-50 dark:border-gray-800/50 flex-grow transition-colors ${
                                        item.isDeleted ? "bg-red-50/50 dark:bg-red-900/10" : ""
                                    }`}
                                    title={
                                        item.isDeleted
                                            ? "Click on recover button to recover your visualization"
                                            : undefined
                                    }
                                >
                                        ...
                                        {item.isDeleted ? (
                                            ...
                                            <>
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 bg-blue-100 text-blue-400 dark:bg-blue-800  hover:text-blue-500 hover:bg-blue-200 dark:hover:bg-blue-900/50 rounded-lg transition-all"
                                                ...
                                                <button
                                                    onClick={() => handleDelete(item._id)}
                                                    disabled={actionId === item._id}
                                                    className="p-2 text-red-700 bg-red-400 dark:text-red-800 dark:bg-red-400 hover:text-red-400 hover:bg-red-700 dark:hover:bg-red-900/50 rounded-lg transition-all"
                                                    title="Delete"
                                                >
                                                    <FiTrash2 size={16} />
                                                </button>
