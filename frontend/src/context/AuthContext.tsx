...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
    ...
    const { showAlert } = useAlert() as {
        showAlert: (message: string, title?: string, type?: number) => void;
    };
    ...
    return (
        <AuthContext.Provider
            value={{ user, login, setUser, logout, loading, role, credits, setCredits, token }}
        >
            {!loading && children}
        </AuthContext.Provider>
    );
