                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-16">
                    <div className="col-span-2 md:col-span-3">
                        ...
                        <div className="flex items-center gap-3">
                            <Link
                                to="https://github.com/krupal-036/LumiVizStack"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group flex items-center justify-center gap-3 p-3 rounded-xl 
                        ...
                        <ul className="space-y-4">
                            {footerLinks.product.map((link) => (
                                <li key={link.name}>
                                    <Link
                                        to={link.path}
                                        className="group flex items-center text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                                    >
                                        <FiArrowRight
                                            size={18}
                                            className="mr-0 opacity-0 group-hover:mr-2 group-hover:opacity-100 transition-all duration-300"
                                        />
                                        {link.name}
                                    </Link>
                                </li>
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        ...
                        <div className="space-y-4">
                            <Link
                                ...
                                className="flex items-center justify-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-800/30 border border-gray-200 dark:border-gray-700/50 hover:border-indigo-500/50 transition-colors group w-30 mx-2 font-bold"
                            >
