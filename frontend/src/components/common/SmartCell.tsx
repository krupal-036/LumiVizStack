...
const SmartCell = ({
    ...
    if (value === null || value === undefined) {
        return (
            <span className="text-slate-300 dark:text-slate-700 text-xs italic select-none">
                ∅ null
            </span>
        );
    }
    ...
    if (typeof value === "string") {
        ...
        const isImageExt =
            value.match(/\.(jpeg|jpg|gif|png|svg|webp)$/i) != null ||
        ...
        return (
            <span className="text-slate-700 dark:text-slate-200 text-[13px] leading-snug">
                {value}
            </span>
        );
    }
