...
const parseToGraph = (data: any) => {
    const nodes: any = [];
    const links: any = [];

    const traverse = (currentData: any, parentId: any = null, keyName = "Root") => {
...
const GraphView = ({ data }: { data: any }) => {
    ...
    return (
        <div
            ref={containerRef}
            className="relative w-full h-[600px] bg-gray-50 dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg overflow-hidden"
        >
